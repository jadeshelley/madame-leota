#!/usr/bin/env python3
"""
Madame Leota Interactive Fortune Teller - TESTING VERSION
Main application file with testing configuration
"""
...
class MadameLeotaApp:
    ...
    async def initialize(self):
        ...
        try:
            ...
            self.logger.info("Madame Leota initialized successfully - TESTING MODE!")
            print("\n🔮 TESTING MODE ACTIVE")
